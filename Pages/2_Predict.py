...
with tabs2:
    st.write("""
            ...
            2. **Comparison Graph:** Check the graph below to visually compare the predicted and actual trip durations. The blue dots represent actual values, and orange dots represent predicted values.""")
...
with tabs3:
    st.write("""### Example Input:
        ...
        - Dropoff Longitude: -73.50
        - Dropoff Latitude: 40.00
        - Passenger Count: 1
